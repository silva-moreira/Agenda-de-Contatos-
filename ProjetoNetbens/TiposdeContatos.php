...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="css/tipodecontatos.css">
    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="tipodecontato.php?idTipoDeContato=0">
                <button type="button" class="btn btn-primary">Novo Tipo de Contato</button>
            </a>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php 
                        $select = "SELECT * FROM NomeTipoDeContato;";
                    ...
                    foreach ($retornoDaConsulta as $registro ) {
                        ...
                        $qntContato = utf8_encode($registro["NumeroDeTipoDeContato(IDTIPODECONTATO)"]);
